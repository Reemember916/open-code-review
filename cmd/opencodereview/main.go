...
Commands:
  ...
  scan         Automatically scan an embedded C project
  doctor       Check trial-version dependencies
...
Examples:
  ...
  ocr scan C:\Projects\Q2760               Automatically scan a C project
  ocr doctor                              Check cppcheck and optional LLM setup
