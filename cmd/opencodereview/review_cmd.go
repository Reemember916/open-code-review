...
import (
	...
	"github.com/open-code-review/open-code-review/internal/staticanalysis"
...
func runReview(args []string) error {
	...
	var staticAnalyzers []staticanalysis.Analyzer
	if opts.staticAnalysis {
		staticAnalyzers = staticanalysis.SelectAnalyzers(opts.analyzers, opts.semgrepConfig)
	}
	...
	ag := agent.New(agent.Args{
		...
		StaticDiffContextLines: opts.staticContext,
	})
